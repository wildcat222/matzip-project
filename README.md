...
| **남가람** | 이번 프로젝트에서 여러 부분에서 어려움을 겪으며 많이 배운 시간이었습니다. 특히, 프론트엔드와 백엔드와의 연동 작업에서 예상치 못한 부분에서 자주 막히곤 했습니다. 그를 바탕을 백엔드 수정이 잦아서 처음부터 백엔드 설계를 잘했어야 했다는 생각이 들었습니다. 그래도  이로 인해 프론트와 백엔드의 상호작용을 깊이 이해할 수 있는 기회가 되었습니다. <br>또한, 프로젝트 진행 중 백엔드 API 연결에 여러 어려움을 겪으며, 팀원들의 도움을 통해 문제를 하나씩 해결해 나갈 수 있었습니다. 그 과정에서 팀원들과의 협력이 얼마나 중요한지 깨달았고, 덕분에 새로운 관점에서 문제를 바라보는 방법을 배울 수 있었습니다. 프로젝트를 통해 배운 점과 얻은 경험들은 앞으로의 개발 여정에 큰 자산이 될 것이라고 확신합니다.                                                                                                     |
